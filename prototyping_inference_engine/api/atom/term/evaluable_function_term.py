"""
Evaluable functional term (backed by a computed predicate).
"""
...
class EvaluableFunctionTerm(Term):
    ...
    def apply_substitution(self, substitution) -> "EvaluableFunctionTerm":
        return EvaluableFunctionTerm(
    ...
    def __repr__(self) -> str:
        return f"EvalFunc:{self.__str__()}"
