"""
Logical functional term (pure FOL function symbol).
"""
...
class LogicalFunctionalTerm(Term):
    ...
    def apply_substitution(self, substitution) -> "LogicalFunctionalTerm":
        return LogicalFunctionalTerm(
