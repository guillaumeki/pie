...
Rpx_py = Rule(px, px, label="Rpx_py")
Rqx_rxy = Rule(qx, rxx, label="Rqx_rxy")
Rpxy_qzy = Rule(pzy, qzy, label="Rpxy_qzy")
Rquv_pwv = Rule(qzy, pzy, label="Rquv_pwv")
Rpxy_pyz = Rule(pxy, pyx, label="Rpxy_pyz")
Rpxy_pyy = Rule(pxy, pxy, label="Rpxy_pyy")
