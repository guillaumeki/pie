...
from backward_chaining.unifier.piece_unifier_algorithm import PieceUnifierAlgorithm
...
class TestPieceUnifierAlgorithm(TestCase):
    ...
    def test_compute_most_general_piece_unifiers(self):
        for d in self.data:
            ...
            self.assertEqual(set(PieceUnifierAlgorithm.compute_most_general_piece_unifiers(query, rule)),
                             d["piece_unifiers"])
